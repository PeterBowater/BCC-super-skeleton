...
<body id="#$.getTopID()#" class="twoColSR depth#arrayLen($.event('crumbdata'))# #$.createCSSid($.content('menuTitle'))# default">
...
<div class="super-container full-width content" id="section-thirds">
	...
	<div class="container">
		...
		<div class="sixteen columns" id="page-header">
			...
			#$.dspCrumbListLinks("crumbList","&nbsp;&raquo;&nbsp;", '1')#
			<hr />
...
<div class="super-container full-width">
	...
	<div class="container">
		...
		<!-- CONTENT -->
		<div class="<cfif len(objects3) or len($.content().getImageURL())>eleven<cfelse>sixteen</cfif> columns content">
			...
			<!--- BLOG SUBTYPE OUTPUT --->
				...
				<div id="entry" class="single">
					...
					#$.dspBody(body=$.content('body'),pageTitle='',crumbList=1,showMetaImage=0)#
					<!--- TAGS --->
