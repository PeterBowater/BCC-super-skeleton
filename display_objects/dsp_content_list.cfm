				...
				<cfswitch expression="#arguments.field#">
					...
					<cfcase value="Body">
						<cfif len(arguments.item.getValue('body')) and arguments.item.getValue('body') neq "<p></p>">
							<div class="body">#$.setDynamicContent(arguments.item.getValue('body'))#</div>
						</cfif>
					</cfcase>
					<cfcase value="ReadMore">
					 	<p class="readMore">#$.addLink(arguments.item.getValue('type'),arguments.item.getValue('filename'),$.rbKey('list.readmore'),arguments.item.getValue('target'),arguments.item.getValue('targetparams'),arguments.item.getValue('contentID'),arguments.item.getValue('siteID'),'',$.globalConfig('context'),$.globalConfig('stub'),$.globalConfig('indexFile'))#&nbsp;&raquo;</p>
					</cfcase>
		...
		<dl class="clearfix<cfif arguments.class neq ''> #arguments.class#</cfif>"<cfif arguments.hasImage> #arguments.imageStyles#</cfif>>
			<cfloop list="#arguments.fields#" index="arguments.field">
				...
				<cfswitch expression="#arguments.field#">
					...
					<cfcase value="ReadMore">
					 	<dd class="readMore">#$.addLink(arguments.item.getValue('type'),arguments.item.getValue('filename'),$.rbKey('list.readmore'),arguments.item.getValue('target'),arguments.item.getValue('targetparams'),arguments.item.getValue('contentID'),arguments.item.getValue('siteID'),'',$.globalConfig('context'),$.globalConfig('stub'),$.globalConfig('indexFile'))#&nbsp;&raquo;</dd>
					</cfcase>
					<cfcase value="Credits">
						<cfif len(arguments.item.getValue('credits'))>
