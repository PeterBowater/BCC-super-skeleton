...
<div id="svRatings" class="clearfix">	
	<div id="rateIt">
		<#variables.$.getHeaderTag('subHead1')#>Rate this</#variables.$.getHeaderTag('subHead1')#>
		<form name="rater1" id="rater1" method="post" action="">	
			<input type="hidden" id="rate" name="rate" value="##">
			<input type="hidden" id="userID" name="userID" value="#createUUID()#">
	...
	<div id="avgrating">
		<cfif variables.rsRating.theCount gt 0>
			...
			<img id="ratestars" src="#event.getSite().getThemeAssetPath()#/images/rater/star_#application.raterManager.getStarText(variables.rsRating.theAvg)#.gif" alt="<cfif isNumeric(variables.rsRating.theAvg)>#variables.rsRating.theAvg# star<cfif variables.rsRating.theAvg gt 1>s</cfif></cfif>" border="0"></div>
		</cfif>
